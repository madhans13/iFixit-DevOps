    ...
    <div className="repair-guides-container">
      ...
      <div className="category-grid-top">
        {categoriesTop.map((cat, idx) => (
          <div key={idx} className="category-card-top">{cat}</div>
        ))}
      </div>
